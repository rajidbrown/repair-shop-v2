@extends('layouts.app') {{-- Optional if you use layout inheritance --}}
...
<head>
    <meta charset="UTF-8" />
    <title>Shaded Motorworks - Mechanic Dashboard</title>
...
<body>
<header>
    <h1>Welcome, {{ Auth::user()->name ?? 'Mechanic' }}!</h1>
...
<main>
    ...
    <div class="tiles">
        ...
        <a class="tile" href="{{ route('mechanic.appointments.future') }}">Future Appointments</a>
